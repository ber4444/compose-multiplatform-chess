...
onDeviceAi commonMain            (on-device AI orchestration; published as io.github.ber4444:onDeviceAi)
 ├── androidMain                 (ML Kit/AICore, available via Gemini Nano; coach falls back to deterministic if absent)
