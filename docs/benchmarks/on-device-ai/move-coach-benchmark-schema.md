...
| Android | SM-F926U (Galaxy Z Fold3 5G) | Snapdragon 888 | n/a | Android 15 | Cactus | gemma3-270m | CPU | JIT | ~721 ms / ~913 ms | 1991 ms / 3184 ms | 1993 ms / 3185 ms | ~632 MB | not collected | **60% (3/5)** | 3 runs failed validation (copied JSON template). 2 runs were successful with valid explanations. |
