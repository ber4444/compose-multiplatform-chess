...
| Android | SM-F926U (Galaxy Z Fold3 5G) | Snapdragon 888 | n/a | Android 15 | Cactus | gemma3-270m | CPU | JIT | ~721 ms / ~913 ms | 1991 ms / 3184 ms | 1993 ms / 3185 ms | ~632 MB | not collected | **0% (0/5)** | The 60% fallback rate was fixed by removing JSON from the prompt. Runs produce valid prose strings. |
| Android | Pixel 10 Pro XL | Tensor G5 | n/a | Android 16 | Cactus | gemma3-270m | CPU | JIT | ~723 ms / ~743 ms | 2104 ms / 3362 ms | 2104 ms / 3363 ms | ~593 MB | not collected | **0% (0/5)** | The 80% fallback rate was fixed by removing JSON from the prompt. Runs produce valid prose strings. |
