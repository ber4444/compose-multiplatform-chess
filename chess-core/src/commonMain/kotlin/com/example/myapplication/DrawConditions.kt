...
internal const val FIFTY_MOVE_RULE_HALFMOVES = 100
...
internal fun isInsufficientMaterial(state: GameUiState): Boolean {
...
internal fun isFiftyMoveDraw(state: GameUiState): Boolean {
...
internal fun isThreefoldRepetition(state: GameUiState): Boolean {
...
internal fun applyDrawConditions(state: GameUiState): GameUiState =
